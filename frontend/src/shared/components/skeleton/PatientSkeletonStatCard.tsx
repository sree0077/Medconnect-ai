...
interface PatientSkeletonStatCardProps {
  className?: string;
  withChange?: boolean;
}

export const PatientSkeletonStatCard: React.FC<PatientSkeletonStatCardProps> = ({
  className = '',
  withChange = true
}) => {
  return (
...
export default PatientSkeletonStatCard;
