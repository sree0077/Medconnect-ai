...
export const PatientHeader: React.FC<PatientHeaderProps> = ({ onMenuClick }) => {
  ...
  // Get patient name from auth context or use default
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="hidden md:block text-sm font-medium text-text-secondary">{patientName}</span>
